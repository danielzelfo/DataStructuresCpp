 ...
 *               The constructor of the StandardTrie class reads each word in the text file, ignoring any characters that aren't letters.
 ...
 *				 V1.1: It returns an integer for the number of occurrences of the word in the text.
 *
